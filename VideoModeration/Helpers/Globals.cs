...
namespace VideoModeration
{
    class Globals
    {
        ...
        public const string AZURE_AD_TENANT_NAME = "";
        ...
        public const string TOP_DIR = @"ContentModerator-API-Samples\VideoModeration\Sample files\";
        ...
        public static readonly string CONTENT_MODERATOR_PRESET_FILE = TOP_DIR + "preset.json";
        //Example file:
        //        {
        //             "version": "2.0"
        //        }
